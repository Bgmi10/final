...
const Humanresource = ({ history }) => {
  ...
  const slides = [
    ...
    { id: 2, content: `I learned a lot from nexus and the whole team covering the HR Management Specialization really!! I love the fact that you can go at your own pace. They managed to get all the goods in the 5 courses. I'm starting course #4 now and I get more excited as I go because the info provided is so useful.`, author: 'Nisha Gupta, HR (Intern)' },
    {
          ...
          <ScrollAnimation animateIn="fadeIn">
            <div className="eth " >
              <div className="zero ">
                ...
                <div className="ml-16 mt-6" style={{textAlign:'center', margin:'10px auto'}}>
