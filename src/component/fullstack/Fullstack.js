...
const Fullstack = ({ history }) => {
  ...
  const slides = [
    ...
    { id: 2, content: `It was a really good experience to do the Full Stack Development course from nexus. I have really upskilled my knowledge and got an opportunity to work for one of the esteem companies. Thank you, nexus, for really motivating me and guiding me to choose the correct career path.`, author: 'Rohan Malhotra, Lecturer' },
    {
  ...
  return (
    <Fragment>
      ...
      <ScrollAnimation animateIn="fadeIn" className="desk">
