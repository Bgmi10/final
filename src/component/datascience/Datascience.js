...
const Datascience = ({ history }) => {
  ...
  return (
    <Fragment>
          ...
          <ScrollAnimation animateIn="fadeIn">
            <div className="eth " >
              <div className="zero ">
                ...
                <div className="" style={{textAlign: 'center', margin:'10px auto'}}>
                  <Button variant="contained" style={{margin:'10px auto'}}>
      ...
      <ScrollAnimation animateIn="fadeIn desk">
        ...
        <div className={isimge ? ` chase-2  w-[860px]  ml-96` : `chase-2 mr-20`}>
          {FAQ_auery.map((item, index) => (
            <div className={`name gb ${activeIndex === index ? 'active' : ''}`} key={index}>
    ...
    <img
      src="https://nexus.com/assets/images/others/Cert.png"
      style={isimge ? {
        height: "auto",
        width: "70%",
        marginLeft: "10px",
    ...
    <div style={{ display: "flex", justifyContent: "start", marginTop: "20px" }}>
      <img
        src="https://nexus.com/Courses/images/card-icon-11.png"
    ...
    <div style={{ display: "flex", justifyContent: "start", marginTop: "20px" }}>
      <img
        src="https://nexus.com/Courses/images/card-icon-12.png"
       style={isimge ? { height: "30px", width: "30px", marginLeft: "20px" } : { height: "30px", width: "30px", marginLeft: "" }}
        alt="Icon"
      />
      <p style={{ color: "#b0b0b0", marginLeft: "10px", fontSize: "18px", marginTop: "10px" }}>
