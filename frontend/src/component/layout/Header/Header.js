...
const Header = (props) => {
  ...
  <Dropdown>
    <DropdownButton>
    <NavLink href="#"><span className="hover:text-gray-400 text-lg">Courses</span></NavLink>
    </DropdownButton>
    <DropdownContent>
...
{!user &&      <StyledLogin href="/login" onClick={handleLogin}>
        Login
      </StyledLogin> }
      <MobileMenu>
...
const Dropdown = styled.div`
  position: relative; /* Ensure the dropdown content is positioned relative to the dropdown */
  color: white;
`;

const DropdownContent = styled.div`
  position: absolute; /* Make the dropdown content not affect surrounding layout */
